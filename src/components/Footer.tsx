...
export default function Footer() {
  ...
  // Define correct paths explicitly
  const footerLinks = [
  ...
  return (
    <footer style={{ 
      ...
      <div style={{ marginBottom: "35px", fontFamily: "sans-serif", fontSize: "15px", color: "#1a1a1a" }}>
        <p style={{ marginBottom: "8px" }}>accounts@elixifitout.com</p>
        <p>9673135333</p>
      </div>

      {/* 5. SOCIAL ICONS (Official Filled Logos) */}
      <div style={{ 
        display: "flex", 
        gap: "20px", 
        marginBottom: "40px",
        ...
        {/* Instagram (Filled Gradient Look) */}
        ...
        {/* WhatsApp (Official Green Bubble) */}
